  ...
  if (loading) {
    return (
      <div className="py-8 animate-pulse space-y-6">
        <div className="h-36 rounded-2xl bg-board" />
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            <div className="h-56 rounded-xl bg-board" />
            <div className="h-56 rounded-xl bg-board" />
          </div>
          <div className="space-y-4">
            <div className="h-40 rounded-xl bg-board" />
            <div className="h-40 rounded-xl bg-board" />
          </div>
        </div>
      </div>
    ...
    <div className="pb-12">
      ...
      <div className="relative -mt-10 px-4 md:px-0">
        <div className="max-w-5xl mx-auto flex items-end gap-4">
          <div className="w-24 h-24 md:w-28 md:h-28 rounded-full ring-4 ring-white overflow-hidden bg-board">
            <img
      ...
      {notice && <div className="max-w-5xl mx-auto mt-4 p-3 bg-green-100 text-green-700 rounded">{notice}</div>}
            ...
            {projects && projects.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {projects.slice(0, 6).map(p => (
                  <a key={p.id} href={`#/project/${p.id}`} className="block rounded-lg border border-secondary/10 bg-board p-4 hover:bg-white">
        ...
        <div className="space-y-6">
          <div className="bg-surface border border-secondary/10 rounded-xl p-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-lg bg-board p-4">
