    ...
    return (
        <nav className='bg-surface/80 backdrop-blur-sm shadow-sm sticky top-0 z-10 border-b border-secondary/10'>
            <div className="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <div>
                    <button className="flex items-center gap-2 bg-accent text-white font-semibold px-4 py-2 rounded-lg hover:opacity-90 transition-opacity ml-4"><PlusCircle size={20} /><span>New Project</span></button>
                </div>
            </div>
        </nav>
    )
